    <div class="content" id="footer">  
        <div class="row-fluid">
            ...
            <div class="span4">
                ...
                <div class="mc-field-group" style="margin: 1.3em 5%;clear: both;overflow: hidden;">
                    <label for="mce-MMERGE4" style="display: block;margin: .3em 0;line-height: 1em;font-weight: bold;">State (US) </label>
                    ...
                    <label for="mce-MMERGE5" style="display: block;margin: .3em 0;line-height: 1em;font-weight: bold;">or Province/Region </label>
                    <input type="text" value="" name="MMERGE5" class="" id="mce-MMERGE5">
                </div>
                <div class="mc-field-group" style="margin: 1.3em 5%;clear: both;overflow: hidden;">
                    <label for="mce-MMERGE3" style="display: block;margin: .3em 0;line-height: 1em;font-weight: bold;">Country <strong class="note-required">*</strong>
                    </label>
                    ...
                    <option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <label for="mce-MMERGE6" style="display: block;margin: .3em 0;line-height: 1em;font-weight: bold;">Zip Code</label>
                        <input type="text" value="" name="MMERGE6" class="" id="mce-MMERGE6">
                </div>
                    
                    
                    <div>
                        <input type="hidden" id="group_1" name="group[1][1]" value="1">
                    </div>
                    <div id="mce-responses" style="float: left;top: -1.4em;padding: 0em .5em 0em .5em;overflow: hidden;width: 90%;margin: 0 5%;clear: both;">
                        <div class="response" id="mce-error-response" style="display: none;margin: 1em 0;padding: 1em .5em .5em 0;font-weight: bold;float: left;top: -1.5em;z-index: 1;width: 80%;background: FBE3E4;color: #D12F19;"></div>
                        <div class="response" id="mce-success-response" style="display: none;margin: 1em 0;padding: 1em .5em .5em 0;font-weight: bold;float: left;top: -1.5em;z-index: 1;width: 90%;color: #668000;"></div>
                    </div>
                    <div><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button" style="clear: both;width: auto;display: block;margin: 1em 0 1em 5%;">
                        <input class="close" type="button" value="close" id="mc_embed_close" style="display: none; clear: both;width: auto;margin: 1em 0 1em 5%;"></a>
                    </div>
                </form>
                </div>
                ...
                <script type="text/javascript">
                var fnames = new Array();var ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[4]='MMERGE4';ftypes[4]='dropdown';fnames[5]='MMERGE5';ftypes[5]='text';fnames[3]='MMERGE3';ftypes[3]='dropdown';fnames[6]='MMERGE6';ftypes[6]='text';var err_style = '';
                try{
                    err_style = mc_custom_error_style;
                } catch(e){
                    err_style = 'margin: 0; padding: 1.5em 0.5em 0.5em 0.5em; background: FFEEEE none repeat scroll 0% 0%; font-weight: bold; z-index: 1; width: 200px; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; color: FF0000;';
                }
                var head= document.getElementsByTagName('head')[0];
                ...
                $(document).ready( function($) {
                  var options = { errorClass: 'mce_inline_error', errorElement: 'span', onkeyup: function(){}, onfocusout:function(){}, onblur:function(){}  };
                  var mce_validator = $("#mc-embedded-subscribe-form").validate(options);
                  options = { url: 'http://caminodocumentary.us2.list-manage.com/subscribe/post-json?u=0073eab764f495c2a8232f57b&id=7f031f33de&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
